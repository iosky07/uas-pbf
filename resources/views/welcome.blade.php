        ...
        <div class="row align-items-center">
            <div class="col-lg-12">
                <nav class="navbar navbar-expand-lg navbar-light">
                    <a class="navbar-brand" href="index.html"> <img src="http://sib.pbf.ilkom.unej.ac.id/182410101078/uas/public/frontend/img/logo.png" alt="logo"> </a>
            ...
            <div class="col-lg-6 col-xl-6">
                <div class="banner_text">
                    <div class="banner_text_iner">
                        <h5>Every child yearns to play</h5>
